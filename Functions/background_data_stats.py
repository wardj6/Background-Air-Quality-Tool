...
def get_exceedances(df: pd.DataFrame,
    ...
    """
    Calculate exceedances of pollutant criteria
    :param df: timeseries dataframe containing pollutant data
    :param avg_prd: averaging period
    :param criteria: criteria value
    :param pollutant: pollutant name
    :param key: pollutant column name
    :param no_nepm: option to ignore NEPM requirement of 75% data capture - default is False
    :return: 2 dataframes: return_df (contains number of exceedances), exceedances_df (contains specific dates for each exceedance)
    """
...
def get_stats(pollutant_dict: dict,
    ...
    :param pollutant_dict: Dictionary of pollutant data
    :param avg_prd: averaging period
    :param no_nepm: option to ignore NEPM requirement of 75% data capture - default is False
    :return: Three dataframes: resampled_df (calculated stats), capture_df (calculated data capture rates),
    removed_data_periods_df (itemisation of periods removed due to low data capture rate)
    """
...
def get_percentiles(pollutant_dict: dict,
    ...
    :return: dataframe containing calculated percentiles
    """
...
def get_no2_nox_ratios(pollutant_dict: dict) -> pd.DataFrame:
    """
    Calculate NO2 to NOx ratios
    :param pollutant_dict: Dictionary of pollutant data
    :return: single dataframe containing ratios
    """
