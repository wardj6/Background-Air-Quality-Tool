...
def gui_inputs():
    ...
    heat_map_grp.add_argument("--end_date", metavar="End Date", widget="DateChooser", default='2020-12-31')
    ...
    stations_grp.add_argument("--end_date", metavar="End Date", widget="DateChooser", default='2020-12-31')
    ...
    charts_stations_grp.add_argument("--end_date", metavar="End Date", widget="DateChooser", default='2020-12-31')
    ...
    temp_rain_charts = subs.add_parser("temperature_rainfall_charts")

    temp_rain_charts_grp = temp_rain_charts.add_argument_group("Stations/ Period", gooey_options={"show_border": True, "columns": 2})
    temp_rain_charts_grp.add_argument('stations', metavar="Station/s",
                                     help="Type the station/s of interest, separated by a comma - must be in the same state for criteria purposes",
                                     type=str)
    temp_rain_charts_grp.add_argument('output', metavar='Output Folder', help="Charts will be output to this folder",
                                     widget="DirChooser")

    temp_rain_charts_grp.add_argument("--start_d", metavar="Start Date", widget="DateChooser", default='2010-01-01')
    temp_rain_charts_grp.add_argument("--end_d", metavar="End Date", widget="DateChooser", default='2020-12-31')

    temp_rain_charts_grp.add_argument("--temp_y_axis", metavar="Optional temperature axis range", help="e.g. '0-40'", type=str)
