...
def concat_images(image_list) -> Image:
    """
    A function to concatenate heat map images into a single image
    :param image_list: a list of paths fr the images to concatenate
    :return: an Image object for the output image
    """

    # A dictionary to govern the layout of the concatenated image
...
def heat_map(
    ...
    """
    Main function to generate heat map charts
